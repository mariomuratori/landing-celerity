...
<script>
  ...
  import onlineworld from '../../public/images/online-world.svg';
  import bgpattern from '../../public/images/bg-pattern.png';
</script>

<!--END ABOUT US-->
<section class="section bg-light common-section" id="features">
  <Container>
      ...
      <Col lg="5">
        <div class="features-box">
          ...
          <ul class="text-muted list-unstyled mt-4 features-item-list">
            {#each feature_list as list}
              <li class="">{list}</li>
            {/each}
          </ul>
          <a href="{'#'}" class="btn btn-primary mt-4 waves-effect waves-light"
            >Learn More <i class="mdi mdi-arrow-right" /></a
          >
        </div>
      </Col>
      <Col lg="7">
  ...
  <Container>
    <Row>
      <Col lg="12" class="text-center">
        ...
        <a href="{'#pricing'}" class="btn btn-white mt-4 waves-effect waves-light mb-5">View Plan & Pricing</a>
      </Col>
    </Row>
  </Container>
